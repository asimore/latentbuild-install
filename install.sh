...
REPO_ROOT=""
RUN_DOCTOR="1"
EXPECTED_SHA256="423133122ea1dfaf51f511bf1e3d66076545f946649e41c5bb3c807cc6baea69"
...
Options:
  --version <version>      Version to install. Defaults to 1.0.4.
  --sha256 <digest>        Expected wheel SHA-256. Defaults to 1.0.4 digest.
