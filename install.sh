...
RUN_DOCTOR="1"
UPDATE_PATH="1"
EXPECTED_SHA256="dfcc884142c48195beb6c25e973406f464bd7ad526c7f21ec030c2621a94c9da"
...
Options:
  --version <version>      Version to install. Defaults to 1.1.3.
  --sha256 <digest>        Expected wheel SHA-256. Defaults to 1.1.3 digest.
