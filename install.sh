...
RUN_DOCTOR="1"
UPDATE_PATH="1"
EXPECTED_SHA256="b3393ff9c41f8cadfbb94db1457aaac6c34f013926e28d090e15170d49d6e243"
...
Options:
  --version <version>      Version to install. Defaults to 1.1.4.
  --sha256 <digest>        Expected wheel SHA-256. Defaults to 1.1.4 digest.
