...
RUN_DOCTOR="1"
UPDATE_PATH="1"
EXPECTED_SHA256="e6feaa59630e5a9012ef0bb805bae2bbae78c176e42f44cf9a3d870fc6c99f3c"
...
Options:
  --version <version>      Version to install. Defaults to 1.0.9.
  --sha256 <digest>        Expected wheel SHA-256. Defaults to 1.0.9 digest.
