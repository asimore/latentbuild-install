...
REPO_ROOT=""
RUN_DOCTOR="1"
EXPECTED_SHA256="e5b557f094b3083754afd3b2c0f813a37c3abbaf673b5dad299b57c7598faf8b"
...
Options:
  --version <version>      Version to install. Defaults to 1.0.2.
  --sha256 <digest>        Expected wheel SHA-256. Defaults to 1.0.2 digest.
