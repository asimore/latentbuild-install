...
RUN_DOCTOR="1"
UPDATE_PATH="1"
EXPECTED_SHA256="4a5fe626b18e75007b95dcb590e3b70a8db68facd02930bb948b5b8c370a13d7"
...
Options:
  --version <version>      Version to install. Defaults to 1.1.5.
  --sha256 <digest>        Expected wheel SHA-256. Defaults to 1.1.5 digest.
